function TeamCard({ user }) {
  return (
    <section className="rounded-3xl bg-white p-5 shadow-soft">
      ...
      <p className="mt-1 text-sm text-slate-500">Stay aligned with contributors and project owners.</p>
      <div className="mt-4 rounded-2xl bg-brand-500 p-4 text-white">
        ...
        <p className="text-center text-sm text-white/90">Project manager</p>
      </div>
    </section>
  );
}
